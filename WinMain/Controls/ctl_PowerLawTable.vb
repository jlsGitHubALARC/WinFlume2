...
'*****************************************************************************************************************
' Class:    ctl_PowerLawTable overrides ctl_DataTableParameter to allow Power Law Table specific extensions
'
Imports DataStore
Imports DataStore.DataStore

Public Class ctl_PowerLawTable
...
#Region " UI Event Handlers "
    ...
    Protected Sub PowerLawRowContextMenu_Popup(ByVal sender As System.Object, ByVal e As System.EventArgs) _
    Handles RowContextMenu.Popup

        RowContextMenu.MenuItems.Add("-")
        RowContextMenu.MenuItems.Add(mDictionary.tPowerLawFromFieldData.Translated, _
                                     New EventHandler(AddressOf PowerLawFromFieldData_Click))
    End Sub

    Protected Sub PowerLawFromFieldData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Handles PowerLawFromFieldData.Click (menu items are dynamically created by ...Menu_Popup()
        ...
        If (mUnit IsNot Nothing) Then
            ...
            If (_dialogResult = DialogResult.OK) Then
                ...
                row.Item(1) = SiValue(_furrowFieldData.PowerLawWidthAt100mm, mUnitsSystem.DepthUnits)
                row.Item(2) = _furrowFieldData.PowerLawExponent
                row.Item(3) = SiValue(_furrowFieldData.PowerLawMaximumDepth, mUnitsSystem.DepthUnits)
                SaveDataTable(table, mDictionary.tPowerLawFieldData.Translated)
