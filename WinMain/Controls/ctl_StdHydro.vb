...
'**********************************************************************************************
' ctl_StdHydro - UI for viewing & editing the Standard Hydrograph inflow data
'
' Note - ctl_StdHydro is a slimmed-down version of ctl_StandardHydrograph.  It is meant for use
'        in ctl_InflowRunoff.
'
' Only time-based cutoff & cutback are correctly supported.  Support for distance-based cutoff
' and/or cutback will require additional work.
'
Imports DataStore
Imports DataStore.DataStore

Public Class ctl_StdHydro
