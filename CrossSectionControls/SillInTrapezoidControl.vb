...
'*************************************************************************************************************
' Class SillInTrapezoidControl  - UserControl for drawing & editing a Sill-In-Trapezoid cross section
'
...
#Region " UI Methods "
    ...
    Public Overrides Sub AnnotateDrawing(ByVal eGraphics As Graphics)
        ...
        ' Position 'Annotations' relative to trapezoid's outline
        ...
        ' Bottom Width (i.e. Outer Bottom Width)
        Dim OBW As Single = mSection.OuterBottomWidth
        Dim OBWtext As String = UnitsDialog.UiValueUnitsText(OBW, "m")
        Dim OBWsize As SizeF = eGraphics.MeasureString(OBWtext, Me.Font)

        dx = (outer(2).X - outer(1).X - OBWsize.Width) / 2
    ...
    '*********************************************************************************************************
    ' Sub PositionControls() - position contained Controls relative to trapezoid's outline
    '*********************************************************************************************************
