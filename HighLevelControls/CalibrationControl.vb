...
'*************************************************************************************************************
' Class CalibrationControl - UserControl for displaying & editing the Flume's Calibration
'*************************************************************************************************************
    ...
    Protected Sub UpdateUI()
        ...
        If (mWinFlumeForm IsNot Nothing) Then
            ...
            If Not (mUpdatingUI) Then
                ...
                Me.TableChoicesControl.UpdateUI(mWinFlumeForm)
                Me.RatingTableControl.UpdateUI(mWinFlumeForm)
                Me.RatingEquationControl.UpdateUI(mWinFlumeForm)
                Me.DitchridersTableControl.UpdateUI(mWinFlumeForm)

                If (WinFlumeForm.LocateSubtabs = TabAlignment.Top) Then
                    Me.CalibrationControlTabControl.Alignment = TabAlignment.Top
                Else
                    Me.CalibrationControlTabControl.Alignment = TabAlignment.Bottom
                End If
...
#Region " Event Handlers "
    ...
    '*********************************************************************************************************
    Private Sub CalibrationControlTabControl_ValueChanged() Handles CalibrationControlTabControl.ValueChanged
        If (mWinFlumeForm IsNot Nothing) Then
